  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SqliteRow:
        final data = json.decode(param) as Map<String, dynamic>;
        switch (T) {
          case ReadSSCCCounterRow:
            return ReadSSCCCounterRow(data);
          case ReadPalletConfigRow:
            return ReadPalletConfigRow(data);
          case CheckCartonParentRelationRow:
            return CheckCartonParentRelationRow(data);
          case LoadGeneratedSSCCsRow:
            return LoadGeneratedSSCCsRow(data);
          case ReadAllSsccDataRow:
            return ReadAllSsccDataRow(data);
          case ReadAllBatchSerialsRow:
            return ReadAllBatchSerialsRow(data);
          case ValidateUserRow:
            return ValidateUserRow(data);
          case LoadBatchSerialsSnapShotRow:
            return LoadBatchSerialsSnapShotRow(data);
          case LoadUsersRow:
            return LoadUsersRow(data);
          case ReadAllAggregationConfigRow:
            return ReadAllAggregationConfigRow(data);
          case CheckIfCartonInBatchRow:
            return CheckIfCartonInBatchRow(data);
          case ReadCartonsInPalletsCountRow:
            return ReadCartonsInPalletsCountRow(data);
          default:
            return null;
        }
