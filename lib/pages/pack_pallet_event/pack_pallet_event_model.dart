...
class PackPalletEventModel extends FlutterFlowModel<PackPalletEventWidget> {
  ...
  // Stores action output result for [Backend Call - SQLite (Check Carton Parent Relation)] action in Pack_Pallet_Event widget.
  List<CheckCartonParentRelationRow>? parentChildQueryResult;
  // Stores action output result for [Backend Call - SQLite (CheckIfCarton In Batch)] action in Pack_Pallet_Event widget.
