...
import 'pack_bundle_event_model.dart';
export 'pack_bundle_event_model.dart';

class PackBundleEventWidget extends StatefulWidget {
  const PackBundleEventWidget({
    super.key,
    this.gneratedSSCC,
  });
  ...
  static String routeName = 'Pack_Bundle_Event';
  static String routePath = '/packBundleEvent';

  @override
  State<PackBundleEventWidget> createState() => _PackBundleEventWidgetState();
}

class _PackBundleEventWidgetState extends State<PackBundleEventWidget> {
  late PackBundleEventModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PackBundleEventModel());
