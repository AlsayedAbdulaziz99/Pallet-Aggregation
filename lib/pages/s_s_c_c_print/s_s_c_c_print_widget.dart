                ...
                Container(
                  ...
                  child: custom_widgets.ScannerListenerWidget(
                    ...
                    OnScanCaseScan: (code) async {
                      _model.parsedCaseSSCC = await actions.parseBarcode(
                        code,
                        GS1AIs.sscc,
                      );
                      if (_model.parsedCaseSSCC != null &&
                          _model.parsedCaseSSCC != '') {
                        safeSetState(() {
                        ...
                        _model.getCartonParentResponse =
                          ...
                          cartonSscc: _model.parsedCaseSSCC,
                        );
                                ...
                                child: FFButtonWidget(
                                  onPressed: (_model.ssccTextController.text == '')
                                      ...
                                      : () async {
                                          ...
                                          if (_model.ssccTextController.text !=
                                                  '') {
                                            _model.printManualPalletResponse =
                                                await PrintManualPalletCall
                                                    .call(
